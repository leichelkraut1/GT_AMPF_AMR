...
from Otto_API.Models.Missions import resolveMissionRobotId
from Otto_API.TagSync.Robots import readRobotInventoryMetadata
...
def make_instance_name(mission):
    ...
    """
    name = sanitizeTagName(mission.name)
    short = mission.id[:8]
