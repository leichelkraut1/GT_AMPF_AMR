...
PLC_FLEET_MAPPING_ROOT_TAG_PATH = PLC_ROOT_TAG_PATH + "/FleetMapping"
...
INTERLOCK_MAPPING_TAG_PATH = PLC_FLEET_MAPPING_ROOT_TAG_PATH + "/InterlockMapping"
...
def getPlcFleetMappingPath():
    return PLC_FLEET_MAPPING_ROOT_TAG_PATH
...
def getInterlockMappingPath():
    return INTERLOCK_MAPPING_TAG_PATH
