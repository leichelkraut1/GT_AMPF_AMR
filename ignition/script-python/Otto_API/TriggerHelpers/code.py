...
def ensureMissionTriggerTags(workflowIds=None, robotIds=None):
    ...
    updateInterlocksPath = buildMissionTriggerPath(systemUpdatesBase, "updateInterlocks")
    ...
    ensureMemoryTag(updateInterlocksPath, "Boolean", False)
    ...
    createdPaths.append(updateInterlocksPath)
