def onTagChange(initialChange, newValue, previousValue, event, executionCount):
	...
	if system.tag.read("[Otto_FleetManager]Fleet/Triggers/SystemUpdates/ProvisionControllerTags").value == True:
	    ...
	    MainController.State.Provisioning.ensureRuntimeTags()
